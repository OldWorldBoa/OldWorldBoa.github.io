...
; (function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        events: function () {
            ...
            letters.on('click tap', function () {
                me.type((shift || capslock) ? $(this).text().toUpperCase() : $(this).text());
            });

            space_key.on('click tap', function () {
                me.type(' ');
            });

            return_key.on('click tap', function () {
                me.type("\n");
                me.settings.input.parents('form').submit();
            });

            backspace_key.on('click tap', function () {
                me.backspace();
            });

            shift_key.on('click tap', function () {
